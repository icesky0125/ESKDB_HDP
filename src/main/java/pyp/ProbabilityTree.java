...
public class ProbabilityTree {
	...
	public ProbabilityTree(int nValuesConditionedVariable, int[] nValuesConditioningVariables, boolean createFullTree,int m_Iterations, TyingStrategy m_Tying,int frequencySamplingC,boolean usePYP,int frequencySamplingD) {
	...
	public double smooth() {
		root.setDiscountRecursively(0.0);
...
//		System.out.println(root.printTksAndNksRecursively("root"));
...
//		 System.out.println(root.printTksAndNksRecursively("root"));
	...
	public void addDataset(int[][] data) {
		...
		lgCache = new LogStirlingCache(root.d, data.length);
	...
	public void smoothTree() {
		if (lgCache == null)
			lgCache = new LogStirlingCache(root.d, nDatapoints);
		this.smooth();
	}
	...
	public static void main(String... args) {
		...
		// tree.logScoreTree());
		// System.out.println(tree.printTksAndNks() + "\n");
		System.out.println("final d=" + tree.root.d + "\n");
